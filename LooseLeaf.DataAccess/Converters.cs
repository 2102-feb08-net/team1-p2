...
namespace LooseLeaf.DataAccess
{
    ...
    {
        public static IBook ConvertToIBook(this Book book) => new Business.Models.Book(book.Id, book.Title, book.Author, book.Isbn, book.Genres.Select(g => g.GenreName).ToList());
